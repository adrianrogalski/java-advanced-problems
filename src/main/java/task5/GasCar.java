 ...
 * CZĘŚĆ 2
 * Wyprowadź klasę z GasCar, w której spróbuj zepsuć działanie obu metod (nadpisując je, tak aby np. można było zatankować ujemną
...
public class GasCar {
    ...
    // metoda zwracająca aktualny poziom baku
