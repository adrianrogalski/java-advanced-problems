 ...
 * 1. Klasa EmailAddress przechowująca poprawny adres email (jeden znak @, co najmniej jedna kropka za @, tylko znaki alfanumeryczne)
...
public class Task6 {
    public static void main(String[] args) {
        ...
        try {
            address = EmailAddress.of("adrianrogalski09@gmail.com");
        }
