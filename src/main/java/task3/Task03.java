 ...
 * (musisz zmienić listę pól i przedefiniować/dodać/usunąć odpowiednie metody, aby
...
public class Task03 {
    public static void main(String[] args) {
        ...
        System.out.println(superZi.sendsSMS("Hello"));
        System.out.println(handyWatch.sendsSMS("Hello"));
        System.out.println(iDaisy.sendsSMS("Hello"));
        handyWatch.setWiFi(true);
        System.out.println(handyWatch.sendsSMS("Hello"));
        superZi.setWiFi(true);
        superZi = new CellPhone(3000, "Czułałej", null, 16_000_000);
        System.out.println(superZi.sendsSMS("Hello again"));
    }
}